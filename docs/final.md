...
- [7. Security, HA & DR Considerations](#7-security-ha-dr-considerations)
  ...
  - [7.2. Permission – Azure RBAC for PCFv2](#72-permission-azure-rbac-for-pcfv2)
    - [7.2.1. Permission Details of role](#721-permission-details-of-role)
      - [7.2.1.1. Reader-Permissions](#7211-reader-permissions)
      - [7.2.1.2. Contributor - Permissions](#7212-contributor---permissions)
      - [7.2.1.3. User Access Administrator -Permissions](#7213-user-access-administrator--permissions)
      - [7.2.1.4. Support Request Contributor-Permissions](#7214-support-request-contributor-permissions)
      - [7.2.1.5. Storage Blob Data Reader-Permissions](#7215-storage-blob-data-reader-permissions)
      - [7.2.1.6. Resource Policy Contributor-Permissions](#7216-resource-policy-contributor-permissions)
      - [7.2.1.7. Network Contributor-Permissions](#7217-network-contributor-permissions)
      - [7.2.1.8. Monitoring Contributor-Permissions](#7218-monitoring-contributor-permissions)
  - [7.3. Emergency Break-Glass account](#73-emergency-break-glass-account)
    - [7.3.1. Introduction](#731-introduction)
    - [7.3.2. AS-IS – Break-Glass account Architecture](#732-as-is-break-glass-account-architecture)
    - [7.3.3. Access – Emergency Break-Glass account](#733-access-emergency-break-glass-account)
      - [7.3.3.1. Account Configuration](#7331-account-configuration)
    - [7.3.4. SMEs: Who They Are and How to Contact Them](#734-smes-who-they-are-and-how-to-contact-them)
    - [7.3.5. Validation – Break Glass account](#735-validation-break-glass-account)
  - [7.4. Security - Microsoft Defender for Cloud](#74-security---microsoft-defender-for-cloud)
    - [7.4.1. Policies and Initiatives](#741-policies-and-initiatives)
      - [7.4.1.1. Guest account permission on azure resources](#7411-guest-account-permission-on-azure-resources)
      - [7.4.1.2. Audit for compliance of minimum TLS version](#7412-audit-for-compliance-of-minimum-tls-version)
      - [7.4.1.3. Security features – Storage Account](#7413-security-features-storage-account)
      - [7.4.1.4. Network Policy](#7414-network-policy)
      - [7.4.1.5. SQL Policy Initiatives](#7415-sql-policy-initiatives)
      - [7.4.1.6. KeyVault - Policy Initiatives](#7416-keyvault---policy-initiatives)
...
- [14. Source-only sections](#14-source-only-sections)
  - [14.1. Application Team – AD Group Naming Convention](#141-application-team-ad-group-naming-convention)
    - [14.1.1. How are Security AD Groups created?](#1411-how-are-security-ad-groups-created)
    - [14.1.2. Naming Convention](#1412-naming-convention)
...
Table 18: App Team - Default Role Description
...
Table 19: AAD Group Member and Owner
...
### 7.2. Permission – Azure RBAC for PCFv2
...
##### 7.2.1.2. Contributor - Permissions
...
##### 7.2.1.3. User Access Administrator -Permissions
...
##### 7.2.1.4. Support Request Contributor-Permissions
...
##### 7.2.1.5. Storage Blob Data Reader-Permissions
...
##### 7.2.1.6. Resource Policy Contributor-Permissions
...
##### 7.2.1.7. Network Contributor-Permissions
...
##### 7.2.1.8. Monitoring Contributor-Permissions
...
### 7.3. Emergency Break-Glass account
...
#### 7.3.2. AS-IS – Break-Glass account Architecture

![Figure 5](images/source_368_figure_5.png)

Figure 4: Break-Glass account Access Framework

#### 7.3.3. Access – Emergency Break-Glass account

##### 7.3.3.1. Account Configuration
...
Table 31: Break-Glass account configuration

#### 7.3.4. SMEs: Who They Are and How to Contact Them
...
#### 7.3.5. Validation – Break Glass account
...
### 7.4. Security - Microsoft Defender for Cloud
...
Table 32: Security Initiative - Guest Account Permission

##### 7.4.1.2. Audit for compliance of minimum TLS version
...
Table 33: Security Initiative - Audit on TLS version

##### 7.4.1.3. Security features – Storage Account
...
Table 34: Security Initiative - Storage Account

##### 7.4.1.4. Network Policy
...
Table 35: Security Initiative - Network Policy

##### 7.4.1.5. SQL Policy Initiatives
...
Table 36: Security Initiative - SQL PAAS

##### 7.4.1.6. KeyVault - Policy Initiatives
...
Table 37: Security Initiative – KeyVault
...
Table 38: Existing - Role Assignment
...
### 14.1. Application Team – AD Group Naming Convention

#### 14.1.1. How are Security AD Groups created?
