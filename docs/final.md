...
### Table of Contents
- [Document Metadata](#1-document-metadata)
- [Problem Statement](#2-problem-statement)
- [Design Goals & Non-Goals](#3-design-goals-non-goals)
- [Architecture Overview](#4-architecture-overview)
- [Design Options Considered](#5-design-options-considered)
- [Chosen Design & Rationale](#6-chosen-design-rationale)
- [Security, HA & DR Considerations](#7-security-ha-dr-considerations)
- [Operational Implications](#8-operational-implications)
- [Risks & Assumptions](#9-risks-assumptions)
- [Design Constraints & Dependencies (OPTIONAL)](#10-design-constraints-dependencies-optional)
- [Lifecycle & Evolution Considerations (OPTIONAL)](#11-lifecycle-evolution-considerations-optional)
- [Out-of-Scope / Deferred Decisions (OPTIONAL)](#12-out-of-scope-deferred-decisions-optional)
- [References](#13-references)
- [Source-only sections](#14-source-only-sections)
...
#### Creation/Deletion new AD Group
...
### Application Team – AD Group Naming Convention
...
### Default Authorization – Application Team
...
### Application Team - Role Based Access Control

#### Application Support Engineers Default Access
...
### Default Authorization – HaCT Team

#### HaCT – Cloud Engineer – Default Access
...
### Permission – Azure RBAC for PCFv2
...
#### Access – Emergency Break-Glass account
...
##### Guest account permission on azure resources
...
##### Audit for compliance of minimum TLS version
...
#### Alerts on Critical role assignment
...
#### Alerts on creation of new custom role
...
#### Role Assignment of Application Team
...
#### Membership of AD group of Application Team
