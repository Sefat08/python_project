...
- [2. Problem Statement](#2-problem-statement)
  ...
  - [2.2. Role Based Access Control](#22-role-based-access-control)
...
- [4. Architecture Overview](#4-architecture-overview)
  ...
  - [4.2. Application Team – AD Group Naming Convention](#42-application-team-ad-group-naming-convention)
    - [4.2.1. How are Security AD Groups created?](#421-how-are-security-ad-groups-created)
    - [4.2.2. Naming Convention](#422-naming-convention)
- [5. Design Options Considered](#5-design-options-considered)
- [6. Chosen Design & Rationale](#6-chosen-design-rationale)
  - [6.1. Default Authorization – Application Team](#61-default-authorization-application-team)
    - [6.1.1. RBAC – Application Team](#611-rbac-application-team)
    - [6.1.2. Azure AD Group Ownership and Membership](#612-azure-ad-group-ownership-and-membership)
- [7. Security, HA & DR Considerations](#7-security-ha-dr-considerations)
  - [7.1. Application Team - Role Based Access Control](#71-application-team---role-based-access-control)
    - [7.1.1. Application Support Engineers Default Access](#711-application-support-engineers-default-access)
      - [7.1.1.1. Lower Environment – DEV/SANDBOX](#7111-lower-environment-devsandbox)
      - [7.1.1.2. Upper Environment – UAT/PROD](#7112-upper-environment-uatprod)
  - [7.2. Default Authorization – HaCT Team](#72-default-authorization-hact-team)
    - [7.2.1. HaCT – Cloud Engineer – Default Access](#721-hact-cloud-engineer-default-access)
    - [7.2.2. HaCT – Cloud Engineer - Role Specific Access](#722-hact-cloud-engineer---role-specific-access)
    - [7.2.3. HaCT – Automation Service Principal - Role Specific Access](#723-hact-automation-service-principal---role-specific-access)
    - [7.2.4. Azure AD Role – HaCT Security and IAM Team](#724-azure-ad-role-hact-security-and-iam-team)
    - [7.2.5. Approval Workflow](#725-approval-workflow)
  - [7.3. Permission – Azure RBAC for PCFv2](#73-permission-azure-rbac-for-pcfv2)
    - [7.3.1. Permission Details of role](#731-permission-details-of-role)
      - [7.3.1.1. Reader-Permissions](#7311-reader-permissions)
      - [7.3.1.2. Contributor - Permissions](#7312-contributor---permissions)
      - [7.3.1.3. User Access Administrator -Permissions](#7313-user-access-administrator--permissions)
      - [7.3.1.4. Support Request Contributor-Permissions](#7314-support-request-contributor-permissions)
      - [7.3.1.5. Storage Blob Data Reader-Permissions](#7315-storage-blob-data-reader-permissions)
      - [7.3.1.6. Resource Policy Contributor-Permissions](#7316-resource-policy-contributor-permissions)
      - [7.3.1.7. Network Contributor-Permissions](#7317-network-contributor-permissions)
      - [7.3.1.8. Monitoring Contributor-Permissions](#7318-monitoring-contributor-permissions)
  - [7.4. Emergency Break-Glass account](#74-emergency-break-glass-account)
    - [7.4.1. Introduction](#741-introduction)
    - [7.4.2. AS-IS – Break-Glass account Architecture](#742-as-is-break-glass-account-architecture)
    - [7.4.3. Access – Emergency Break-Glass account](#743-access-emergency-break-glass-account)
      - [7.4.3.1. Account Configuration](#7431-account-configuration)
    - [7.4.4. SMEs: Who They Are and How to Contact Them](#744-smes-who-they-are-and-how-to-contact-them)
    - [7.4.5. Validation – Break Glass account](#745-validation-break-glass-account)
  - [7.5. Security - Microsoft Defender for Cloud](#75-security---microsoft-defender-for-cloud)
    - [7.5.1. Policies and Initiatives](#751-policies-and-initiatives)
      - [7.5.1.1. Guest account permission on azure resources](#7511-guest-account-permission-on-azure-resources)
      - [7.5.1.2. Audit for compliance of minimum TLS version](#7512-audit-for-compliance-of-minimum-tls-version)
      - [7.5.1.3. Security features – Storage Account](#7513-security-features-storage-account)
      - [7.5.1.4. Network Policy](#7514-network-policy)
      - [7.5.1.5. SQL Policy Initiatives](#7515-sql-policy-initiatives)
      - [7.5.1.6. KeyVault - Policy Initiatives](#7516-keyvault---policy-initiatives)
  - [7.6. Disclaimer and Important notes](#76-disclaimer-and-important-notes)
      - [7.6.1.1. Role Assignment – scope – Tenant](#7611-role-assignment-scope-tenant)
      - [7.6.1.2. Important Note](#7612-important-note)
...
- [14. Source-only sections](#14-source-only-sections)
  - [14.1. Appendix – A Glossary](#141-appendix-a-glossary)
...
### 4.2. Application Team – AD Group Naming Convention

#### 4.2.1. How are Security AD Groups created?
...
### 6.1. Default Authorization – Application Team

#### 6.1.1. RBAC – Application Team
...
#### 6.1.2. Azure AD Group Ownership and Membership
...
### 7.1. Application Team - Role Based Access Control

#### 7.1.1. Application Support Engineers Default Access

##### 7.1.1.1. Lower Environment – DEV/SANDBOX
...
##### 7.1.1.2. Upper Environment – UAT/PROD
...
### 7.2. Default Authorization – HaCT Team

#### 7.2.1. HaCT – Cloud Engineer – Default Access
...
#### 7.2.2. HaCT – Cloud Engineer - Role Specific Access
...
#### 7.2.3. HaCT – Automation Service Principal - Role Specific Access
...
#### 7.2.4. Azure AD Role – HaCT Security and IAM Team
...
### 7.3. Permission – Azure RBAC for PCFv2
...
##### 7.3.1.2. Contributor - Permissions
...
##### 7.3.1.3. User Access Administrator -Permissions
...
##### 7.3.1.4. Support Request Contributor-Permissions
...
##### 7.3.1.5. Storage Blob Data Reader-Permissions
...
##### 7.3.1.6. Resource Policy Contributor-Permissions
...
##### 7.3.1.7. Network Contributor-Permissions
...
##### 7.3.1.8. Monitoring Contributor-Permissions
...
### 7.4. Emergency Break-Glass account
...
#### 7.4.2. AS-IS – Break-Glass account Architecture

![Figure 5](images/source_368_figure_5.png)

Figure 4: Break-Glass account Access Framework

#### 7.4.3. Access – Emergency Break-Glass account

##### 7.4.3.1. Account Configuration
...
#### 7.4.4. SMEs: Who They Are and How to Contact Them
...
#### 7.4.5. Validation – Break Glass account
...
### 7.5. Security - Microsoft Defender for Cloud
...
##### 7.5.1.2. Audit for compliance of minimum TLS version
...
##### 7.5.1.3. Security features – Storage Account
...
##### 7.5.1.5. SQL Policy Initiatives
...
##### 7.5.1.6. KeyVault - Policy Initiatives
...
### 7.6. Disclaimer and Important notes

##### 7.6.1.1. Role Assignment – scope – Tenant
