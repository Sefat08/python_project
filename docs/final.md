...
- [4. Architecture Overview](#4-architecture-overview)
  ...
  - [4.3. Default Authorization – Application Team](#43-default-authorization-application-team)
    - [4.3.1. RBAC – Application Team](#431-rbac-application-team)
    - [4.3.2. Azure AD Group Ownership and Membership](#432-azure-ad-group-ownership-and-membership)
  - [4.4. Application Team - Role Based Access Control](#44-application-team---role-based-access-control)
    - [4.4.1. Application Support Engineers Default Access](#441-application-support-engineers-default-access)
      - [4.4.1.1. Lower Environment – DEV/SANDBOX](#4411-lower-environment-devsandbox)
      - [4.4.1.2. Upper Environment – UAT/PROD](#4412-upper-environment-uatprod)
  - [4.5. Default Authorization – HaCT Team](#45-default-authorization-hact-team)
    - [4.5.1. HaCT – Cloud Engineer – Default Access](#451-hact-cloud-engineer-default-access)
    - [4.5.2. HaCT – Cloud Engineer - Role Specific Access](#452-hact-cloud-engineer---role-specific-access)
    - [4.5.3. HaCT – Automation Service Principal - Role Specific Access](#453-hact-automation-service-principal---role-specific-access)
    - [4.5.4. Azure AD Role – HaCT Security and IAM Team](#454-azure-ad-role-hact-security-and-iam-team)
    - [4.5.5. Approval Workflow](#455-approval-workflow)
...
### 4.3. Default Authorization – Application Team

#### 4.3.1. RBAC – Application Team
...
#### 4.3.2. Azure AD Group Ownership and Membership
...
### 4.4. Application Team - Role Based Access Control

#### 4.4.1. Application Support Engineers Default Access

##### 4.4.1.1. Lower Environment – DEV/SANDBOX
...
##### 4.4.1.2. Upper Environment – UAT/PROD
...
### 4.5. Default Authorization – HaCT Team

#### 4.5.1. HaCT – Cloud Engineer – Default Access
...
#### 4.5.2. HaCT – Cloud Engineer - Role Specific Access
...
#### 4.5.3. HaCT – Automation Service Principal - Role Specific Access
...
#### 4.5.4. Azure AD Role – HaCT Security and IAM Team
